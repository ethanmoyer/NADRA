...
dataset_validation_loc = str(input('Enter the location of the processed validation data: '))
if (dataset_validation_loc.find("processed_data") < 0 or dataset_validation_loc.find("train") < 0):
...
model_train = model.fit(X_train, y_train, batch_size=batch_size,
                        ...
                        validation_data=(dataset_validation, y_val))
